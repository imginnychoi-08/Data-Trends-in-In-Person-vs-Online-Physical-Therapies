...
| Rndrng_Prvdr_Type | Tot_Bene_Day_Srvcs | Place_Of_Srvc | Year |
|-------------------|--------------------|---------------|------|
| Physical Therapist | O | In Private Practice | 20 |
| Physical Therapist | F | In Private Practice | 22 |
| Physical Therapist | O | In Private Practice | 23 |
| Physical Therapist | F | In Private Practice | 24 |
...
Part 2 shows a graph of both in-person and online moving in an upward direction. This could possibly be a result of wanting to utilize their insurance coverage on an option that seems more reliable and effective, which is the in-person session since AI and technology has not advanced to its fullest potential. However, the slope or the rate of change for online physical therapy is higher. From the graphs, we can assume that as technology is advancing, more and more people will start to utilize virtual therapy. However, still compared to the numbers of in-person visits, the online one is far less, this shows that technology only recently started and began enhancing acceleratingly. Therefore, the increase for in-person sessions is much higher than the increase for online sessions.
